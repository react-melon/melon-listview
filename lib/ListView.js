(function (global, factory) {
    if (typeof define === "function" && define.amd) {
        define(['exports', 'react', 'melon-core/classname/cxBuilder', './DataSource', './StaticRenderer', './babelHelpers'], factory);
    } else if (typeof exports !== "undefined") {
        factory(exports, require('react'), require('melon-core/classname/cxBuilder'), require('./DataSource'), require('./StaticRenderer'), require('./babelHelpers'));
    } else {
        var mod = {
            exports: {}
        };
    ...
    var ListView = function (_Component) {
        ...
        ListView.prototype.render = function render() {
            ...
            var component = props.component,
                ...
                rest = babelHelpers.objectWithoutProperties(props, ['component', 'dataSource', 'renderRow']);
